...
const calcPopupPanelLocation = ({
  ...
  const viewportWidth = document.documentElement.clientWidth - viewportBoundaryInset * 2
  const viewportHeight = document.documentElement.clientHeight - viewportBoundaryInset * 2
