  ...
  return (
    ...
    >
      {!haveAnime ? (
        <div
          className={twMerge(
            `${iconSize} rounded-full overflow-hidden`,
            className
          )}
        >
          <Image
        ...
        <div
          ...
          style={{
            ['--delay' as string]: `${(Math.random() * 1000).toFixed(2)}ms`,
          }}
        >
          <Image
            className="front-face overflow-hidden transition-transform transform"
            src={iconSrc}
            fallbackSrc="/coins/unknown.svg"
            alt="coin"
          />
          ...
          <Image
            className="back-face overflow-hidden transition-transform transform"
            src={iconSrc}
            fallbackSrc="/coins/unknown.svg"
            alt="coin"
          />
